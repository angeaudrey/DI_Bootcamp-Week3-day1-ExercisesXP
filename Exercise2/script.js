...
let change = document.getElementsByTagName('ul')[0];
console.log(change.firstElementChild.style.display='none');

// 4- Add a border to the <li> that contains the text node “Pete”.
console.log(change.lastElementChild.style.border="solid");

// 5- Change the font size of the whole body.
console.log(document.body.style.fontSize="50px");